...
class basic_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_sink_x_0_0_1_0_1_1 = qtgui.sink_c(
            1024, #fftsize
            window.WIN_BLACKMAN_hARRIS, #wintype
            0, #fc
            20e6, #bw
            'XLATING_Receiver', #name
            True, #plotfreq
            False, #plotwaterfall
            False, #plottime
            False, #plotconst
        ...
        self.qtgui_sink_x_0_0_1_0_1_1.set_update_time(1.0/500)
        self._qtgui_sink_x_0_0_1_0_1_1_win = sip.wrapinstance(self.qtgui_sink_x_0_0_1_0_1_1.qwidget(), Qt.QWidget)

        self.qtgui_sink_x_0_0_1_0_1_1.enable_rf_freq(True)

        self.top_layout.addWidget(self._qtgui_sink_x_0_0_1_0_1_1_win)
        self.freq_xlating_fft_filter_ccc_0 = filter.freq_xlating_fft_filter_ccc(1, lowpass_custom_taps, freq, samp_rate)
        ...
        # Connections
        ##################################################
        self.connect((self.freq_xlating_fft_filter_ccc_0, 0), (self.qtgui_sink_x_0_0_1_0_1_1, 0))
    ...
    def set_lowpass_custom_taps(self, lowpass_custom_taps):
        ...
        self.freq_xlating_fft_filter_ccc_0.set_taps(self.lowpass_custom_taps)
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.freq_xlating_fft_filter_ccc_0.set_center_freq(self.freq)
